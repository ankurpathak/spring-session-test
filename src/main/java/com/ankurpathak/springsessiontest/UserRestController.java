...
@ApiController
public class UserRestController extends AbstractRestController<User, UserDto, String> {
    ...
    public ResponseEntity<?> createOne(HttpServletRequest request, HttpServletResponse response, @RequestBody @Validated UserDto dto, BindingResult result){
